...
matière et par niveau. Il est **tenu à jour depuis le corpus** — chiffres,
ancrages et état des démonstrations en sont extraits, et non recopiés à la
main. Toute entrée qui y figure est appelable telle quelle.
...
| CM1 | école | 11 | 11 | 0 | 0 |
| CM2 | école | 15 | 15 | 0 | 0 |
| sixième | collège | 28 | 28 | 0 | 0 |
| cinquième | collège | 61 | 42 | 9 | 10 |
| quatrième | collège | 61 | 33 | 15 | 13 |
| troisième | collège | 55 | 36 | 10 | 9 |
| seconde | lycée | 83 | 42 | 18 | 23 |
| première | lycée | 120 | 37 | 43 | 40 |
| terminale | lycée | 143 | 61 | 48 | 34 |
| licence 1 | supérieur | 181 | 101 | 45 | 35 |
| licence 2 | supérieur | 191 | 61 | 66 | 64 |
...
|---|---|---|---|
| définition | `Comparaison de longueurs` | CP | · |

#### nombres et calculs

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Addition de deux entiers naturels` | CP | · |
| définition | `Chiffre et nombre` | CP | · |
| propriété | `Comparaison de deux entiers naturels` | CP | · |
| définition | `Double et moitié` | CP | · |
| définition | `Soustraction de deux entiers naturels` | CP | · |
| propriété | `Successeur d'un entier naturel` | CP | · |
| définition | `Unité et dizaine` | CP | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Unités usuelles de longueur` | CE1 | · |

#### géométrie

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Angle droit` | CE1 | · |
| définition | `Segment et droite` | CE1 | · |

#### nombres et calculs

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| propriété | `Associativité de l'addition` | CE1 | · |
| définition | `Centaine` | CE1 | · |
| propriété | `Commutativité de l'addition` | CE1 | · |
| propriété | `Commutativité de la multiplication` | CE1 | · |
| définition | `Multiplication de deux entiers naturels` | CE1 | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Quotient et reste` | CE2 | · |

#### grandeurs et mesures

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Périmètre d'un polygone` | CE2 | · |
| définition | `Unités usuelles de masse` | CE2 | · |
...
|---|---|---|---|
| définition | `Périmètre d'un polygone` | CE2 | · |
| définition | `Polygone` | CE2 | · |

#### nombres et calculs

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| propriété | `Associativité de la multiplication` | CE2 | · |
| propriété | `Distributivité de la multiplication sur l'addition` | CE2 | · |
| définition | `Millier` | CE2 | · |
| définition | `Quotient et reste` | CE2 | · |
| définition | `Unité fractionnaire` | CE2 | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Aire d'un rectangle` | CM1 · sixième | · |
| définition | `Aire d'une surface plane` | CM1 | · |
| définition | `Unités usuelles de contenance` | CM1 | · |
...
| définition | `Droites parallèles du plan` | CM1 | · |
| définition | `Droites perpendiculaires` | CM1 | · |
| propriété | `Propriétés du carré` | CM1 · sixième | · |

#### nombres et calculs

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Fraction` | CM1 | · |
| définition | `Fraction décimale` | CM1 | · |
| définition | `Nombre décimal` | CM1 | · |
| définition | `Partie entière et partie décimale` | CM1 | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| propriété | `Comparaison de deux fractions` | CM2 · sixième | · |
| propriété | `Égalité de deux fractions` | CM2 · sixième | · |

#### arithmétique

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| propriété | `Critères de divisibilité par 2, 5 et 10` | CM2 · sixième · terminale | 🕐 à rédiger |
| définition | `Diviseur et multiple` | CM2 · sixième | · |

#### grandeurs et mesures

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| règle | `Conversion entre unités décimales` | CM2 | · |
| propriété | `Volume d'un pavé droit` | CM2 · sixième | · |
| définition | `Volume d'un solide` | CM2 | · |

#### géométrie

| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Agrandissement et réduction` | CM2 | · |
| définition | `Patron d'un solide` | CM2 | · |
| définition | `Polyèdre` | CM2 | · |
| propriété | `Volume d'un pavé droit` | CM2 · sixième | · |
| définition | `Volume d'un solide` | CM2 | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| propriété | `Comparaison de deux nombres décimaux` | CM2 | · |
| propriété | `Multiplication et division par une puissance de dix` | CM2 | · |
| propriété | `Somme de deux fractions de même dénominateur` | CM2 | · |
...
|---|---|---|---|
| définition | `Agrandissement et réduction` | CM2 | · |
| définition | `Pourcentage` | CM2 · sixième | · |
| définition | `Situation de proportionnalité` | CM2 · sixième | · |
...
| règle | `Conversion des unités d'aire et de volume` | sixième | · |
| définition | `Échelle d'un plan` | sixième | · |
...
| propriété | `Conservation par symétrie axiale` | CM1 · sixième | · |
| définition | `Demi-droite graduée` | sixième | · |
| propriété | `Distance d'un point à une droite` | sixième | · |
| définition | `Médiatrice d'un segment` | sixième | · |
| propriété | `Périmètre d'un cercle` | sixième | · |
| propriété | `Propriétés du carré` | CM1 · sixième | · |
| définition | `Rayon, diamètre et corde` | sixième | · |
...
|---|---|---|---|
| définition | `Demi-droite graduée` | sixième | · |
| définition | `Écriture fractionnaire` | sixième | · |
| règle | `Priorités opératoires` | sixième | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Effectif et fréquence` | sixième | · |
...
| règle | `Test d'une égalité` | cinquième | · |
...
| définition | `Hauteur d'un triangle` | cinquième | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| propriété | `Augmentation et diminution en pourcentage` | cinquième | · |
| définition | `Vitesse moyenne` | cinquième · quatrième | · |
...
| définition | `Puissance d'exposant entier relatif` | quatrième | · |
...
| propriété | `Règles de calcul sur les puissances` | quatrième | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| règle | `Produit de deux nombres relatifs` | quatrième | · |
| définition | `Puissance d'exposant entier relatif` | quatrième | · |
| règle | `Quotient de deux nombres relatifs` | quatrième | · |
| propriété | `Règles de calcul sur les puissances` | quatrième | · |
...
| définition | `Image et antécédent` | troisième | · |
| définition | `Représentation graphique d'une fonction` | troisième | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| règle | `Arbre de probabilités` | troisième | · |
...
| Type | Appel | Ancrages | Démonstration |
|---|---|---|---|
| définition | `Atome` | quatrième · troisième | · |
| définition | `Ion` | troisième | · |
| définition | `Molécule` | quatrième · troisième | · |
