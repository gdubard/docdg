...
> `cargo app recensement --redaction` le réécrit depuis `corpus/corpus.db`
...
*Engendré depuis `corpus/corpus.db` et `transpiler/src/maths/demonstrations.json` par `cargo app recensement --redaction`.*
