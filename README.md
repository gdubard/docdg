...
Le corps d'une étape est du docdg vivant : prose, mathématiques `$…$`, interpolations `#variable` et commandes du langage s'y composent librement. Les documents `exemples/demonstration3.txt` et `exemples/demonstration4.txt`, eux, ne contiennent aucun corps : ils montrent ce que le moteur démontre et rédige seul.
