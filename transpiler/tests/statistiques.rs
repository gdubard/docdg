...
fn le_college_ne_laisse_aucun_bloc_absent() {
    let h = rendu(include_str!("../../exemples/statistiques-probabilites2.txt"));
    assert!(!h.contains("calcul-absent"));
}
...
fn les_trois_fichiers_de_statistiques_sont_complets() {
    for source in [
        include_str!("../../exemples/statistiques-probabilites2.txt"),
        include_str!("../../exemples/statistiques-probabilites3.txt"),
        include_str!("../../exemples/statistiques-probabilites4.txt"),
    ] {
